...
<td class="buy_button"><div align="center"><a style="color: black; text-decoration: none; text-size: 20; font-family: Century Gothic;" href="index.php?view=add_to_cart_list_sub_cat&id=<?php echo $item['id']?>">В корзину</a></div></td>
</tr>
